...
def make_client(api_key: str | None = None) -> OpenAI:
    """Build a DeepSeek-compatible client. Defaults to platform key from settings."""
    key = api_key or settings.deepseek_api_key
    if not key:
        raise RuntimeError("DEEPSEEK_API_KEY is not set (settings.deepseek_api_key empty)")
...
def evaluate_paper(
    ...
    """Call DeepSeek to evaluate one paper. Raises on persistent failure."""
